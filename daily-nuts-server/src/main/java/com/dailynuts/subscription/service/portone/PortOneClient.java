...
public class PortOneClient {
    ...
    private static final String API_KEY = "8822717266735664";
    private static final String API_SECRET = "xg0xgnPuyayPXq4IpQ1ypbGXIUj1hrMEdsfPTjhlC6pUmvIEk6SA4rfEFaIvYfFB9FkBkVTQFsUKYikM";
    ...
    private String getAccessToken() {
        PortOneTokenRequestDto bodyDto = new PortOneTokenRequestDto(API_KEY, API_SECRET);
